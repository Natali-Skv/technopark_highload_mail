...
Будем следовать более менее классическому сценарию использования почтового сервиса:
  1. перейти на страницу входящих
  2. перейти на страницу одного письма
  3. вернуться на страницу входящих
  4. повторим пункты 2-3 5 раз для разных писем
  ...
  | просмотр исходящих писем                                   | 50 Кб        | 327 Кб        | 188 Кб |

* **Пиковое потребление в теченнии суток (в Гбит/с). Разбивка по существенным типам трафика (для выбора сетевых
  интерфейсов)**  
  Входящие и исходящие письма будем выдавать постанично, по 30 писем на странице  
