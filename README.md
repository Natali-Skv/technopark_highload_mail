...
|таблица          |количество записей      | объем таблицы        |пик input/day|пик output/day|
|-----------------|------------------------|----------------------|-------|-------|
...
|набор таблиц            |количество записей      | суммарный объем таблиц         |пик input/day|пик output/day|
|------------------------|------------------------|--------------------------------|-------|-------|
