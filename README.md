...
* **хранилище писем пользователя**  
  ...
  Таким образом средний пользователь сможет хранить `5 Гб / (40% * 20 Мб / 5) ~= 3 125 писем`.  
...
Также для данные, которые мы храним в Tarantool будут помещаться в `20 000 000 * 3 * 300 Б = 18Гб`
